...
def bar_chart():
    ...
    submit_button = tk.Button(background, text="Submit", command=lambda: get_bar_chart(file_path_entry.get(),
...
def get_bar_chart(file, chart_title, x_title, x, y_title, y, sum_mean, limit_option, limit_value, chart_key):
